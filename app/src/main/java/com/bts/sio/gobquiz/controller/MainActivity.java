...
import com.bts.sio.gobquiz.model.Scores;
import com.bts.sio.gobquiz.model.User;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mScoreButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                out.println("Tableau des scores avant lancement de l'activité tableau des scores");
                for (User user : mScores.getScoresTab()){
                    out.println(user.getFirstname()+" "+user.getScore());
                }
    ...
    private void greetUser() {
        ...
        String fulltext = "Heureux de te revoir parmi nous !, " + mUser.getFirstname()
                + "!\nTon dernier score était de " + mUser.getScore()
                + ", Seras-tu meilleur cette fois ?";
